...
void main() => runApp(const ClientPaymentPage());

class ClientPaymentPage extends StatefulWidget {
  const ClientPaymentPage({super.key});

  @override
  State<StatefulWidget> createState() => ClientPaymentPageState();
}

class ClientPaymentPageState extends State<ClientPaymentPage> {
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: ExactAssetImage(
                    isLightTheme ? 'assets/img/bg-light.png' : 'assets/img/bg-dark.png',
                  ),
                  fit: BoxFit.fill,
                ),
              ),
